...
public class Coin {
    ...
    private String coinUuid;//算力uuid
    private String coin_id;//算力对应数字货币ID
    private String coin_symbol;//算力对应数字货币symbol
    private String coin_cn_name;//算力名称
    private String coin_icon;//算力对应数字货币icon
    private String coin_introduction;//算力静态收益率
    private String miner_uuid;//算力所属矿机
